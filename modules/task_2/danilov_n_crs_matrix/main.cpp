...
// Need only one test that omp multiply is equal to seq
// other functions of class have tested in seq main.cpp
TEST(CRSMatrix, Test_Correct_Matrix_Multiplication_OMP) {
    ...
    auto result_omp = ompMultiply(CRSMatrix<double>(a), CRSMatrix<double>(b));
